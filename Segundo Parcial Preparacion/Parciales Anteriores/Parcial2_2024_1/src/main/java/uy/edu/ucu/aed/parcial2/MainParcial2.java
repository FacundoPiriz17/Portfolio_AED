...
public class MainParcial2 
{
    public static void main( String[] args )
    {
        ...
        TCaminos<TNodoDeLaRed> caminos = grafo.caminosDesdeHasta("NP_3", "NP_4");
        ...
        String[] linkedList = caminos.imprimirCaminos().split("\n");
        ManejadorArchivosGenerico.escribirArchivo("salida.txt",linkedList);
